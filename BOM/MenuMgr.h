...
public:
	...
	void SetWorkMode(WORK_MODE workMode );
...
private:
	...
	vector<Menu_Item*>  m_LoginMenus;//登录界面的菜单
	vector<Menu_Item*> m_InitAbnormalMenus;//初期化失败界面的菜单
