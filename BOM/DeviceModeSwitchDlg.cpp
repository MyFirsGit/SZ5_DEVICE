...
// 初始化常量字符串
static const TCHAR* const STR_NORMAL_MODE =  _T("正常模式");
static const TCHAR* const STR_TEST_MODE   =  _T("测试模式");
static const TCHAR* const TXT_CURRENT_MODE = _T("当前设备模式：");
static const TCHAR* const TXT_SWITCH_MODE  = _T("选择设备模式：");
...
{
	m_baseInfo->titleInfo.titleName = TITLE_MODE_SWITCH_INFO;              // 标题
...
{
	// 初始化模式切换信息
	m_modeSwitchInfo[0].nameLeft = add_wsp(TXT_CURRENT_MODE,MAX_SBC_CASE_LEN);
	m_modeSwitchInfo[1].nameLeft = add_wsp(TXT_SWITCH_MODE,MAX_SBC_CASE_LEN);
