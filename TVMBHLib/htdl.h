...
// 需要等待ON/OFF命令
#define CMD_BH_RESET			0x54	  //"T"		复位
#define CMD_BH_CONFIG			0x42	  //"B*"	钞票配置
//v1直接写


// 通信阶段定义
#define	MAX_PHASE	6			// 通信状态数量
#define PHASE_S1		0				// Phase 1, 空闲，等待命令发送事件
#define PHASE_S2		1				// Phase 2, 命令发送完毕，等待ACK / NAK
#define PHASE_S3		2				// Phase 3, 等待空闲应答码ON
#define PHASE_S4		3				// Phase 4, 有应答命令等待STX
#define PHASE_S5		4				// Phase 5, 等待ETX
#define PHASE_S6		5				// Phase 6, 等待BCC
...
#define EVENT_ACK				4			// 收到ACK
#define EVENT_NAK				5			// 收到NAK
#define EVENT_ON				6			// 收到空闲应答
#define EVENT_OFF				7			// 收到忙碌应答
#define EVENT_TIMEOUT		8			// 超时
#define EVENT_ERROR			9			// 错误
...
#define ON				0x11		// 空闲应答码
#define OFF				0x13		// 忙碌应答码
...
typedef struct htdl_work_tag
{
	...
	bool	bisNeedWaitOnOff;					// 是否需要等待系统忙碌结束
	//--------------------------------------------------------
