========================================================================
    MICROSOFT 基础类库 : CTStatusDisplayLIB 项目概况
========================================================================


应用程序向导已为您创建了此 CTStatusDisplayLIB DLL。此 DLL 不仅
说明了使用 Microsoft 基础类的基础，而且
也是编写 DLL 的起点。

此文件包含组成 CTStatusDisplayLIB DLL
的每个文件的内容摘要。

CTStatusDisplayLIB.vcproj
    这是用应用程序向导生成的 VC++ 项目的主项目文件。
    它包含有关生成此文件的 Visual C++ 版本的信息，以及
    有关使用应用程序向导选择的
    平台、配置和项目功能的信息。

CTStatusDisplayLIB.cpp
    这是包含 DllMain() 
    定义的主 DLL 源文件。
CTStatusDisplayLIB.rc
    这是程序使用的所有 Microsoft Windows 资源的列表。
    它包含存储在 RES 子目录下的图标、位图和光标。
    此文件可在 Microsoft Visual C++ 中直接编辑。
    

res\CTStatusDisplayLIB.rc2
    此文件包含不由 Microsoft 
    Visual C++ 编辑的资源。您应将不能由
    资源编辑器编辑的所有资源放置在此文件中。

CTStatusDisplayLIB.def
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 CTStatusDisplayLIB.pch
