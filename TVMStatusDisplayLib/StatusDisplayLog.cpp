...
*/
//////////////////////////////////////////////////////////////////////////
void CTSPLog::Initialize(const char* tracePath) 
{
	// 保存日志存放目录
...
*/
//////////////////////////////////////////////////////////////////////////
void CTSPLog::printf(const char *fmt, ...)
{
	// 格式化字符串
	char buffer[1024*50];
	va_list arglist;
...
*/
//////////////////////////////////////////////////////////////////////////
void CTSPLog::print(const char *text)
{
	// 进入临界区
...
*/
//////////////////////////////////////////////////////////////////////////
void CTSPLog::MakeFullName(char* strFullName) 
{
    strcpy(strFullName, m_strTracePath);
...
*/
//////////////////////////////////////////////////////////////////////////
void CTSPLog::MakeFileName(char* fileName) 
{
	SYSTEMTIME sysTime;
	GetLocalTime(&sysTime);
	sprintf(fileName, "TVMStatusDisplayTrace_%04d%02d%02d.log", sysTime.wYear, sysTime.wMonth, sysTime.wDay);
}
