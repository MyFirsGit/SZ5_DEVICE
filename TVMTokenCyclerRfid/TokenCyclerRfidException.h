...
class CS_API CTokenCyclerRfidException :
...
public:
    ...
    CTokenCyclerRfidException(long lDetailID, CString sFileName, long lLineNo, CString sMessage = _T(""));
    ~CTokenCyclerRfidException();
