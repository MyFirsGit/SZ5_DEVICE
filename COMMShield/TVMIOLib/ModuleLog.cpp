...
*/
//////////////////////////////////////////////////////////////////////////
void CModuleLog::Initialize(const char* tracePath) 
{
	// 保存日志存放目录
...
*/
//////////////////////////////////////////////////////////////////////////
void CModuleLog::printf(const char *fmt, ...)
{
	// 格式化字符串
	char buffer[1024*50];
	va_list arglist;
...
*/
//////////////////////////////////////////////////////////////////////////
void CModuleLog::print(const char *text)
{
	// 进入临界区
...
*/
//////////////////////////////////////////////////////////////////////////
void CModuleLog::MakeFullName(char* strFullName) 
{
    strcpy(strFullName, m_strTracePath);
...
*/
//////////////////////////////////////////////////////////////////////////
void CModuleLog::MakeFileName(char* fileName) 
{
	SYSTEMTIME sysTime;
	GetLocalTime(&sysTime);
	sprintf(fileName, "IOTrace_%04d%02d%02d.log", sysTime.wYear, sysTime.wMonth, sysTime.wDay);
}
