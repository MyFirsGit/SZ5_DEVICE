	...
	*/
	...
	public:
		...
		*/
		...
		{
			CString strSql = _T("");
			strSql.Format(_T("insert into tb_CoinInsertRecord(iTransID,\
						 dtOperationTime,	\
						 iCoinTypeCode,	\
						 iQuantity,	\
						 txtReserve)		\
		...
		*/
		...
		{
			CString strSql = _T("");
			strSql.Format(_T("update tb_CoinInsertRecord set \
						  dtOperationTime='%s',	\
						  iCoinTypeCode='%d',		\
						  iQuantity='%d',			\
						  txtReserve='%s' where \
		...
		*/
		...
		{
			CString strSql = _T("");
			strSql.Format(_T("delete from tb_CoinInsertRecord where iTransID='%d'"),iTransID);
			return strSql;
		}
		//////////////////////////////////////////////////////////////////////////
		/*
		...
		*/
		...
		{
			CString strSql = _T("");
			strSql.Format(_T("delete from tb_CoinInsertRecord "));
			return strSql;
		}
		//////////////////////////////////////////////////////////////////////////
		/*
		...
		*/
		...
		CString ToSelectSql()
		{
			CString strSql = _T("select iTransID, \
							 ...
							 iCoinTypeCode,		\
							 iQuantity,		\
							 txtReserve from tb_CoinInsertRecord");
			return strSql;
		}
