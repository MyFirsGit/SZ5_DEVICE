...
{
	/**
	@brief      纸币箱回收箱安装操作记录实体类
	*/
	class BanknoteBoxInstallOperationRecord
	{
	public:
	...
	public:
		...
		*/
		...
		{
			CString strSql = _T("");
			strSql.Format(_T("insert into tb_BanknoteBoxInstallOperationRecord(\
						  dtTransTime,		\
						  txtBanknoteBoxID,		\
						  iTotalAmount,	\
						  txtOperatorID,			\
...
//////////////////////////////////////////////////////////////////////////
		...
		*/
		...
		{
			CString strSql = _T("");
			strSql.Format(_T("update tb_BanknoteBoxInstallOperationRecord set \
						  dtTransTime='%s',		\
						  txtBanknoteBoxID='%s',		\
						  iTotalAmount='%d',	\
						  txtOperatorID='%s',			\
		...
		*/
		...
		{
			CString strSql = _T("");
			strSql.Format(_T("delete from tb_BanknoteBoxInstallOperationRecord  where iID='%d'"),iID);
			return strSql;
		}
		//////////////////////////////////////////////////////////////////////////
		/*
		...
		*/
		...
		{
			CString strSql = _T("");
			strSql.Format(_T("delete from tb_BanknoteBoxInstallOperationRecord "));
			return strSql;
		}
		//////////////////////////////////////////////////////////////////////////
		/*
		...
		*/
		...
		CString ToSelectSql()
		{
			CString strSql = _T("select iID,			 \
							 ...
							 txtOperatorID,			 \
							 txtComment,			 \
							 txtReserve from tb_BanknoteBoxInstallOperationRecord");
			return strSql;
		}
