	...
	*/
	...
	public:
		...
		*/
		...
		{
			CString strSql = _T("");
			strSql.Format(_T("insert into tb_CoinChangeRecord(\
						  iTransID,\
						  dtOperationTime,\
						  txtCoinBoxID,\
						  iCoinTypeCode,\
		...
		*/
		...
		{
			CString strSql = _T("");
			strSql.Format(_T("update tb_CoinChangeRecord set \
						  dtOperationTime='%s',\
						  txtCoinBoxID='%s',\
						  iCoinTypeCode='%d',\
						  iQuantity='%d',\
		...
		*/
		...
		{
			CString strSql = _T("");
			strSql.Format(_T("delete from tb_CoinChangeRecord where iTransID='%d'"),
						  iTransID);
			return strSql;
		}
		//////////////////////////////////////////////////////////////////////////
		...
		*/
		...
		{
			CString strSql = _T("");
			strSql.Format(_T("delete from tb_CoinChangeRecord "));
			return strSql;
		}
		//////////////////////////////////////////////////////////////////////////
		/*
