...
public:
    ...
    CBaseDlg(UINT ID, CWnd* pParent = NULL, CRect position = CRect(0,0,1024,768), 
    ...
    void DrawText(CDC* pDC, int x, int y, CString sText, CString sFont = TITLE_FONT_NAME,
        int nFontSize = TITLE_FONT_SIZE, int nFontWeight = FW_BOLD, COLORREF crColor = BLACK);                                     // 在指定位置显示文字
    void DrawText(CDC* pDC, CRect& rect, CString sText, CString sFont = TITLE_FONT_NAME,
...
protected:
	...
	virtual void OnClientLanguageModeChanged(LANGUAGETYPE_T&);								                //语言变化绘制函数
...
#define ON_LINEGROUP_BUTTON_CLICK(groupID, memberFxn)\
{ WM_XLINEGROUP, groupID, 0, 0, AfxSig_lwl, \
	(AFX_PMSG)(AFX_PMSGW) \
	(static_cast< LRESULT (AFX_MSG_CALL CBaseDlg::*)(WPARAM, LPARAM) > \
	(memberFxn)) },
...
#define ON_BTN_NOPRINT_CLICK(memberFxn)\
{ WM_XBUTTON, 5, 0, 0, AfxSig_lwl, \
	(AFX_PMSG)(AFX_PMSGW) \
	(static_cast< LRESULT (AFX_MSG_CALL CBaseDlg::*)(WPARAM, LPARAM) > \
	(memberFxn)) },

#define ON_BTN_OkAndCancel1_CLICK(memberFxn)\
{ WM_XBUTTON, 6, 0, 0, AfxSig_lwl, \
	(AFX_PMSG)(AFX_PMSGW) \
	(static_cast< LRESULT (AFX_MSG_CALL CBaseDlg::*)(WPARAM, LPARAM) > \
	(memberFxn)) },

#define ON_BTN_OkAndCancel2_CLICK(memberFxn)\
{ WM_XBUTTON, 7, 0, 0, AfxSig_lwl, \
	(AFX_PMSG)(AFX_PMSGW) \
	(static_cast< LRESULT (AFX_MSG_CALL CBaseDlg::*)(WPARAM, LPARAM) > \
	(memberFxn)) },

#define ON_BTN_SELECT_LANGUAGE_CLICK(memberFxn)\
{ WM_XBUTTON, 8, 0, 0, AfxSig_lwl, \
	(AFX_PMSG)(AFX_PMSGW) \
	(static_cast< LRESULT (AFX_MSG_CALL CBaseDlg::*)(WPARAM, LPARAM) > \
	(memberFxn)) },

#define ON_BTN_CHARGE_CLICK(memberFxn)\
{ WM_XBUTTON, 9, 0, 0, AfxSig_lwl, \
	(AFX_PMSG)(AFX_PMSGW) \
	(static_cast< LRESULT (AFX_MSG_CALL CBaseDlg::*)(WPARAM, LPARAM) > \
	(memberFxn)) },

#define ON_BTN_CASH_PAY_CLICK(memberFxn)\
{ WM_XBUTTON, 10, 0, 0, AfxSig_lwl, \
	(AFX_PMSG)(AFX_PMSGW) \
	(static_cast< LRESULT (AFX_MSG_CALL CBaseDlg::*)(WPARAM, LPARAM) > \
	(memberFxn)) },

#define ON_BTN_NET_PAY_CLICK(memberFxn)\
{ WM_XBUTTON, 11, 0, 0, AfxSig_lwl, \
	(AFX_PMSG)(AFX_PMSGW) \
	(static_cast< LRESULT (AFX_MSG_CALL CBaseDlg::*)(WPARAM, LPARAM) > \
	(memberFxn)) },
