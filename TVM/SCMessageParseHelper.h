...
/************************************************************************/
	...
	bool ParsePersonalizationReply(LPBYTE lpContent,vector<Personalization>& result);
	bool ParseHistoryInfoQuerryReply(LPBYTE lpContent,vector<HistoryProductInfo>& result);
