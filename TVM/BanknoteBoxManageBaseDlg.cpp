...
IMPLEMENT_DYNAMIC(CBanknoteBoxManageBaseDlg, COperationDlg)
	BEGIN_MESSAGE_MAP(CBanknoteBoxManageBaseDlg, COperationDlg)
		ON_WM_CREATE()
		ON_WM_ACTIVATE()
	END_MESSAGE_MAP()
	...
	*/
	//////////////////////////////////////////////////////////////////////////
	CBanknoteBoxManageBaseDlg::CBanknoteBoxManageBaseDlg(CService* pService)
		: COperationDlg(CBanknoteBoxManageBaseDlg::IDD,pService)
	{
		pSvc = (CBanknoteBoxManageSvc*)pService;
	}
	...
	*/
	//////////////////////////////////////////////////////////////////////////
	CBanknoteBoxManageBaseDlg::~CBanknoteBoxManageBaseDlg()
	{
	}
	...
	*/
	////////////////////////////////////////////////////////////////////////////
	int CBanknoteBoxManageBaseDlg::OnCreate(LPCREATESTRUCT lpCreateStruct)
	{
	...
	*/
	//////////////////////////////////////////////////////////////////////////
	void CBanknoteBoxManageBaseDlg::OnActivate(UINT nState, CWnd* pWndOther, BOOL bMinimized)
	{
		__super::OnActivate(nState, pWndOther, bMinimized);

		CBanknoteBoxManageSvc::Model& model = pSvc->GetDataModel();
		...
		// 基本画面（菜单选择）
		if (pSvc->GetCurDialogGroupID() == CBanknoteBoxManageSvc::DIALOG_GROUP_BASE) {
			InitBaseUI();
		...
		// 操作画面（安装、卸载）
		else if (pSvc->GetCurDialogGroupID() == CBanknoteBoxManageSvc::DIALOG_GROUP_OPERATION || pSvc->GetCurDialogGroupID() == CBanknoteBoxManageSvc::DIALOG_GROUP_FINISH) {
			if (model.operation_type == CBanknoteBoxManageSvc::OPERATION_ATTACH_BOX) {
				InitAttachBoxUI();
			}
			else if (model.operation_type == CBanknoteBoxManageSvc::OPERATION_DETACH_BOX) {
				InitDetachBoxUI();
			}
			theAPP_SESSION.ShowOfficeGuide(_opl(GUIDE_ENTER_F2_F3_ESC));
			// 显示错误文言
			if (!pSvc->GetShowErrorMsg().IsEmpty() && pSvc->GetCurDialogGroupID() == CBanknoteBoxManageSvc::DIALOG_GROUP_FINISH){
	...
	*/
	//////////////////////////////////////////////////////////////////////////
	void CBanknoteBoxManageBaseDlg::UpdateUI()
	{
		CBanknoteBoxManageSvc::Model& model = pSvc->GetDataModel();
	...
	*/
	//////////////////////////////////////////////////////////////////////////
	void CBanknoteBoxManageBaseDlg::InitBaseUI()
	{
		m_baseInfoArea->SetLableWidth(LABEL_COL_1, FULL_WITDH);
	...
	*/
	//////////////////////////////////////////////////////////////////////////
	void CBanknoteBoxManageBaseDlg::InitAttachBoxUI()
	{
		// 基本信息格式
		m_baseInfoArea->SetLableAlign(LABEL_COL_1, DT_LEFT | DT_VCENTER);
		...
		// 菜单栏格式
		if (pSvc->GetCurDialogGroupID() == CBanknoteBoxManageSvc::DIALOG_GROUP_OPERATION)
		{
	...
	*/
	//////////////////////////////////////////////////////////////////////////
	void CBanknoteBoxManageBaseDlg::InitDetachBoxUI()
	{
		// 基本信息格式
		m_baseInfoArea->SetLableAlign(LABEL_COL_1, DT_LEFT | DT_VCENTER);
		m_baseInfoArea->SetLableAlign(LABEL_COL_2, DT_LEFT | DT_VCENTER);
		...
		// 纸币信息显示栏格式
		int offset = (pSvc->GetCurDialogGroupID() == CBanknoteBoxManageSvc::DIALOG_GROUP_OPERATION) ? 0 : 1; // 完成页面比执行页面多一行
	...
	*/
	//////////////////////////////////////////////////////////////////////////
	void CBanknoteBoxManageBaseDlg::Clear()
	{
		for (int i = 0; i < 15; ++i)
		{
		...
		{
		case CBanknoteBoxManageSvc::DIALOG_GROUP_BASE:
		case CBanknoteBoxManageSvc::DIALOG_GROUP_OPERATION:
			break;//theAPP_SESSION.ShowOfficeGuide(GUIDE_ENTER_F3_ESC);break;
		case CBanknoteBoxManageSvc::DIALOG_GROUP_FINISH:
		case CBanknoteBoxManageSvc::DIALOG_GROUP_ERROR:
	...
	*/
	//////////////////////////////////////////////////////////////////////////
	void CBanknoteBoxManageBaseDlg::ShowBaseData()
	{
	...
	*/
	//////////////////////////////////////////////////////////////////////////
	void CBanknoteBoxManageBaseDlg::ShowAttachBoxData()
	{
		CBanknoteBoxManageSvc::Model& model = pSvc->GetDataModel();
		CString strID = _T("FFFFFFFF");
		if (pSvc->GetCurDialogGroupID() == CBanknoteBoxManageSvc::DIALOG_GROUP_OPERATION){
			...
			//if( pSvc->GetOperationType() == CBanknoteBoxManageSvc::VIOLATE_UNINSTALL)
			//{
		...
		else if (pSvc->GetCurDialogGroupID() == CBanknoteBoxManageSvc::DIALOG_GROUP_FINISH)
		{
	...
	*/
	//////////////////////////////////////////////////////////////////////////
	void CBanknoteBoxManageBaseDlg::ShowDetachBoxData()
	{
		CBanknoteBoxManageSvc::Model& model = pSvc->GetDataModel();
		CString strID = _T("FFFFFFFF");
		// 纸币箱卸载操作界面
		if (pSvc->GetCurDialogGroupID() == CBanknoteBoxManageSvc::DIALOG_GROUP_OPERATION){
			...
			if( pSvc->GetOperationType() == CBanknoteBoxManageSvc::VIOLATE_INSTALL)
			{
				//箱子实际上安装，但是软计数是卸载状态，非法安装
		...
		else if (pSvc->GetCurDialogGroupID() == CBanknoteBoxManageSvc::DIALOG_GROUP_FINISH) // 卸载完成
		{
			// 安装之前:
