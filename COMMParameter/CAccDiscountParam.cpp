...
CAccDiscountParam CAccDiscountParam::theInstance;
...
*/
//////////////////////////////////////////////////////////////////////////
CAccDiscountParam::CAccDiscountParam():CAccParamMaster()
{
...
*/
//////////////////////////////////////////////////////////////////////////
CAccDiscountParam::~CAccDiscountParam(void)
{	
}
...
*/
//////////////////////////////////////////////////////////////////////////
void CAccDiscountParam::GetParamFileName()
{
	GetParamFileNameSub(ACC_PARAM_ID_0607);		// 获取参数文件名
}
...
*/
//////////////////////////////////////////////////////////////////////////
void CAccDiscountParam::ParseBody(LPBYTE lpData)
{
	try{       
...
*/
//////////////////////////////////////////////////////////////////////////
void CAccDiscountParam::ParseSectionInfo(LPBYTE lpData)
{
	try{
...
*/
//////////////////////////////////////////////////////////////////////////
bool CAccDiscountParam::CheckBodyInfo(LPBYTE lpData)
{   
	return true;
}
