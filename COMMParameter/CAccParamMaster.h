...
/**
 @brief   ACC参数管理父类
*/
class PARAMETERCOMMAND_DECLSPEC CAccParamMaster:public CParameterMaster
{
public:
	bool Internalize(bool readflag,CString dataPath,CString backupPath);         			// 初期化
...
protected:
	...
	// 构造，析构函数
    CAccParamMaster(void);
    ~CAccParamMaster();
    CAccParamMaster(const CAccParamMaster&);
    CAccParamMaster& operator=(const CAccParamMaster&);
