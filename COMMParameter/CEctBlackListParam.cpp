...
CEctBlackListParam CEctBlackListParam::theInstance;
...
*/
//////////////////////////////////////////////////////////////////////////
CEctBlackListParam::CEctBlackListParam():CEctParamMaster()
{
...
*/
//////////////////////////////////////////////////////////////////////////
CEctBlackListParam::~CEctBlackListParam(void)
{	
}
...
*/
//////////////////////////////////////////////////////////////////////////
void CEctBlackListParam::GetParamFileName()
{
	GetParamFileNameSub(ECT_PARAM_ID_4011);		// 获取参数文件名
}
...
*/
//////////////////////////////////////////////////////////////////////////
void CEctBlackListParam::ParseBody(LPBYTE lpData)
{
	try{
...
*/
//////////////////////////////////////////////////////////////////////////
void CEctBlackListParam::ParseSectionInfo(LPBYTE lpData)
{
	try{
...
*/
//////////////////////////////////////////////////////////////////////////
bool CEctBlackListParam::CheckBodyInfo(LPBYTE lpData)
{   
	return true;
}
