...
class SCAUDIT_API CSCAuditException : public CSysException
{
public:
    static const int MODULE_ID = 10121;			// 模块号
    ...
    CSCAuditException(DETAIL_ERROR_CODE lDetailID, CString sFileName, long lLineNo, CString sMessage = _T(""));
    ~CSCAuditException(void);
