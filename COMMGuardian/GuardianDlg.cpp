...
CTGuardianDlg::CTGuardianDlg(CWnd* pParent /*=NULL*/)	: CDialog(CTGuardianDlg::IDD, pParent)
{
	m_hIcon = AfxGetApp()->LoadIcon(IDR_MAINFRAME);
}

BEGIN_MESSAGE_MAP(CTGuardianDlg, CDialog)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
END_MESSAGE_MAP()
...
BOOL CTGuardianDlg::OnInitDialog()
{
...
void CTGuardianDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
	CDialog::OnSysCommand(nID, lParam);
}

void CTGuardianDlg::OnPaint() 
{
	CPaintDC dc(this); 
...
HCURSOR CTGuardianDlg::OnQueryDragIcon()
{
...
*/
//////////////////////////////////////////////////////////////////////////
void CTGuardianDlg::DrawText(CDC* pDC, CRect& rect, CString sText, CString sFont, int nFontSize,int nFontWeight, COLORREF crColor, UINT nFormat)
{
