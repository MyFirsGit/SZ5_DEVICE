...
public:
	...
	int findFinderPattern(BYTE ** mybitmap,int mynWidth,int mynHeight,int myDECIMAL_POINT);
	int getCenter(Line * crossLines,int crossLinesCnt); 
	...
	int calcExactVersion(Point * centers, int * angle, int * moduleSize,int &nVersion);
