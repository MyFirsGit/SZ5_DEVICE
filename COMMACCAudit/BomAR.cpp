...
BomAR BomAR::theInstance;

BomAR::BomAR(void)
{
	m_dataPath = theBOM_INFO.GetDataPath();
	m_BackupPath = theBOM_INFO.GetBackupPath();
	currentFileName = m_dataPath + CString(AR_MANAGE_FOLDER) + CString(AR_MANAGE_BOM_FILE_NAME);	
	BackFileName = m_BackupPath + CString(AR_MANAGE_FOLDER) + CString(AR_MANAGE_BOM_FILE_NAME);
...
*/
//////////////////////////////////////////////////////////////////////////
void BomAR::FindPos(long RegistId,long& theUpdataPosition)
{
			switch(RegistId){
...
*/
//////////////////////////////////////////////////////////////////////////
void BomAR::MakedataByTicketType(long ticketType,long theUpdataPosition,long updataData,LPBYTE addData)
{
...
*/
//////////////////////////////////////////////////////////////////////////
bool BomAR::AddBOMProcessStatByType(long ticketType,long RegistId,long updatedata)                                        
{
...
*/
//////////////////////////////////////////////////////////////////////////
void BomAR::MakePackHead(LPBYTE ARCommHead,int ARFileTag){
...
*/
//////////////////////////////////////////////////////////////////////////
bool BomAR::ReadBOMProcessStat(DEVICE_AR_REASON ARFileTag,VARIABLE_DATA& arMesg)    
{
	try
	{
		CFile cfFile; 
        ...
        // 设置设备类型
		ComRevLong((long)DEVICE_TYPE_TOM,lpData);
		lpData += 4;
