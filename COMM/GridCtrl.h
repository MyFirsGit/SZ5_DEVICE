...
class COMMON_API CGridCtrl : public CWnd
{
...
public:
	...
	void EnableColumnResize(BOOL bEnable = TRUE){ m_bAllowColumnResize = bEnable;}
	void EnableRowResize(BOOL bEnable = TRUE){m_bAllowRowResize= bEnable;}
